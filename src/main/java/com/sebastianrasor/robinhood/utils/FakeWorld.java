package com.sebastianrasor.robinhood.utils;
...
public class FakeWorld extends ClientWorld {
  ...
  @Override
  public boolean setBlockState(BlockPos pos, BlockState state, int flags, int maxUpdateDepth) { return true; }
  ...
  public ClientChunkManager getChunkManager() {
    return MinecraftClient.getInstance().world.getChunkManager();
  }
